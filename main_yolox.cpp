...
int main()
{
	yolox net("/home/oliver-cui/data1/project/data/yolox/yolox_s.onnx", 0.3, 0.3);
	string imgpath = "/home/oliver-cui/data1/project/data/yolox/images/dog.jpg";  ///输入图片的路径，你也可以改成外部传参argv的方式，或者是读取视频文件
...
//	waitKey(0);
//	destroyAllWindows();
    imwrite("/home/oliver-cui/data1/project/data/yolox/res.jpg",srcimg);
    return 0;
}
